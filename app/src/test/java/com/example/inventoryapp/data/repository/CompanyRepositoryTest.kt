...
class CompanyRepositoryTest {
    ...
    @Test
    fun `getAllCompanies delegates to dao`() {
        runBlocking {
            val companies = listOf(
    ...
    @Test
    fun `getCompanyById delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `getCompanyByTaxId delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `searchCompanies delegates to dao`() {
        runBlocking {
            val matches = listOf(
    ...
    @Test
    fun `insertCompany delegates to dao and returns id`() {
        runBlocking {
    ...
    @Test
    fun `updateCompany sets updatedAt and delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `deleteCompany delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `deleteCompanies delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `getCompanyById returns null when dao returns null`() {
        runBlocking {
