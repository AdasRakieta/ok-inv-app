...
class EmployeeRepositoryTest {
    ...
    @Test
    fun `getAllEmployees delegates to dao`() {
        runBlocking {
            val employees = listOf(
    ...
    @Test
    fun `getEmployeeById delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `getEmployeeById returns null when dao returns null`() {
        runBlocking {
    ...
    @Test
    fun `getEmployeeByEmail delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `getEmployeesByCompany delegates to dao`() {
        runBlocking {
            val employees = listOf(
    ...
    @Test
    fun `insertEmployee delegates to dao and returns id`() {
        runBlocking {
    ...
    @Test
    fun `updateEmployee sets updatedAt and delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `deleteEmployee delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `deleteEmployees delegates to dao`() {
        runBlocking {
    ...
    @Test
    fun `getAllDepartments delegates to dao`() {
        runBlocking {
