...
class ContractorPointRepositoryTest {
    ...
    @Test
    fun `getAllContractorPoints delegates to dao`() = runBlocking {
        val points = listOf(
    ...
    @Test
    fun `getContractorPointById delegates to dao`() = runBlocking {
    ...
    @Test
    fun `getContractorPointByCode delegates to dao`() = runBlocking {
    ...
    @Test
    fun `getContractorPointsByType delegates to dao`() = runBlocking {
        val points = listOf(
    ...
    @Test
    fun `getContractorPointsByCompany delegates to dao`() = runBlocking {
        val points = listOf(
    ...
    @Test
    fun `searchContractorPoints delegates to dao`() = runBlocking {
        val points = listOf(
    ...
    @Test
    fun `insertContractorPoint delegates to dao and returns id`() = runBlocking {
    ...
    @Test
    fun `updateContractorPoint sets updatedAt and delegates to dao`() = runBlocking {
        ...
        doNothing().whenever(contractorPointDao).update(any())
    ...
    @Test
    fun `deleteContractorPoint delegates to dao`() = runBlocking {
        val point = ContractorPointEntity(id = 3, code = "CP-003", name = "Delete Point", pointType = PointType.CP, companyId = 2)
        doNothing().whenever(contractorPointDao).delete(point)
    ...
    @Test
    fun `deleteContractorPoints delegates to dao`() = runBlocking {
        val ids = listOf(1L, 2L, 3L)
        doNothing().whenever(contractorPointDao).deleteByIds(ids)
    ...
    @Test
    fun `getContractorPointById returns null when dao returns null`() = runBlocking {
