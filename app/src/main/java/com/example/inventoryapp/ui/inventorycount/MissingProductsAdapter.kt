...
import com.example.inventoryapp.databinding.ItemMissingProductBinding
...
class MissingProductsAdapter : ListAdapter<ProductWithPackageInfo, MissingProductsAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemMissingProductBinding.inflate(
    ...
    class ViewHolder(private val binding: ItemMissingProductBinding) : RecyclerView.ViewHolder(binding.root) {
